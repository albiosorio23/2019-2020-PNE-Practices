...
class Seq:
    ...
    def __init__(self, strbases="NULL"):  # espera que le mandes una secuencia, al ponerle el null si está vacía no te
        # da error
        if strbases == "NULL":
            self.strbases = "NULL"
        ...
        for element in strbases:
            ...
            if element not in list:
                self.strbases = "Error"  # nombre que le das dentro del objeto (self.) ahora queremos comprobar si es
                # correcto antes de almacenarlo
